...
#AVRDUDE_WRITE_FLASH = -U flash:w:$(MAIN_HEX_PATH):i
...
AVRDUDE_BASIC = -c $(AVRDUDE_PROGRAMMER) -p m2560 -P $(AVRDUDE_PORT) -D -b 115200
...
.PHONY:	all testloop build elf hex eep lss sym program coff extcoff clean depend
